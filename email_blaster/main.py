...
class EmailBlaster(object):
    ...
    def get_config(self):
        ...
        try:
            database = self.initalize_database(
                config_file_location, database_file_location
            )

            return database
        except sqlite3.OperationalError:
            logging.warn(
                "Bot detected it was running locally! or there was an error finding a db."
            )
    ...
    def initalize_database(self, cfg_file_loc, db_file_loc):
        ...
        if os.path.isfile(cfg_file_loc):
            ...
            try:
                ...
                logging.error(
                    "Unable to copy file! Permission error! This is not fixed yet!"
                )
        ...
        try:
            ...
            logging.info(
                "Static database and configuration database differ! Updating database."
            )
            ...
            logging.warning(
                'Database was detected to be empty!" \
            ...
            logging.warning(
                'Default database has been coppied." \
